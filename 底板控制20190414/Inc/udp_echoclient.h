...
#define BAT_READ_ALARM          0x21
#define BAT_READ_TEMPER         0x22
...
extern unsigned char posSetPosi[8];
extern unsigned char posSetNega[8];
...
extern unsigned char posArriveCheck[8];
extern unsigned char digIOCheck[8];

extern unsigned char emestopall;
extern unsigned char enstateallm;
extern unsigned char enstateallr;
...
extern unsigned  char modbus_Cmd_Q[modbus_Cmd_Q_Max_Size];
extern int modbus_Cmd_Q_Push;
extern int modbus_Cmd_Q_Pop;
extern int modbus_Cmd_Q_Ctr;
/* 函数声明 ------------------------------------------------------------------*/
