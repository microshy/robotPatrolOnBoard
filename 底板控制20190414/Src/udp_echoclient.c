...
unsigned char posSetPosi[8] = {0x23, 0x7A, 0x60, 0x00, 0x28, 0x23, 0x00, 0x00};
unsigned char posSetNega[8] = {0x23, 0x7A, 0x60, 0x00, 0xD8, 0xDC, 0xFF, 0xFF};
...
unsigned char posArriveCheck[8] = {0x40, 0x41, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00};
unsigned char digIOCheck[8]={0x40,0x89,0x60,0x00,0x00,0x00,0x00,0x00};
...
unsigned char enstateallr = 0;//旋转使能标志位
unsigned char enstateallm = 0;//直行使能标志位
      ...
      //if (crc8 == databuffer[length - 2])
      {
	    ...
	    TOLLEN=0x09;
          ...
          case 0x20:
            ...
            databuffer[12]=0x00;
            databuffer[13]=0x25;
            tmper = bat_state.temper - 0x28;
            databuffer[14]=tmper>>8;
            databuffer[15]=tmper;
            databuffer[16]=0x26;
            databuffer[17]=0x40;
            databuffer[18]=0x27;
