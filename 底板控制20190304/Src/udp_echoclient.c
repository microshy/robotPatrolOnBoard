...
void udp_receive_callback(void *arg, struct udp_pcb *upcb, struct pbuf *p, const ip_addr_t *addr, u16_t port)
{
      ...
      //if (crc8 == databuffer[length - 2])
      {
	    ...
	    TOLLEN=0x09;
          ...
          case 0x20:
            ...
            databuffer[39]=0x26;
            databuffer[40]=MOTOR5.pos>>24;
            databuffer[41]=MOTOR5.pos>>16;
            databuffer[42]=MOTOR5.pos>>8;
            databuffer[43]=MOTOR5.pos;
            databuffer[44]=MOTOR6.pos>>24;
            databuffer[45]=MOTOR6.pos>>16;
            databuffer[46]=MOTOR6.pos>>8;
            databuffer[47]=MOTOR6.pos;
            databuffer[48]=MOTOR7.pos>>24;
            databuffer[49]=MOTOR7.pos>>16;
            databuffer[50]=MOTOR7.pos>>8;
            databuffer[51]=MOTOR7.pos;                                          
            databuffer[52]=MOTOR8.pos>>24;
            databuffer[53]=MOTOR8.pos>>16;
            databuffer[54]=MOTOR8.pos>>8;
            databuffer[55]=MOTOR8.pos;
            databuffer[56]=0x27;
          ...
          case 0x40:
            ...
            if( databuffer[10]==0x43)
            {
              ...
              //l1ang=-(l1angset*6000.0/360.0);
              //r1ang=-(r1angset*6000.0/360.0);
              //l2ang=-(l2angset*6000.0/360.0);
              //r2ang=(r2angset*6000.0/360.0);
              posSet[4]=r1angset;
              posSet[5]=r1angset>>8;
              posSet[6]=r1angset>>16;
              posSet[7]=r1angset>>24;
  ...
  //p_temp->payload = databuffer;
  //p_temp->len=TOLLEN;
  //p_temp->tot_len=TOLLEN;
  //p->payload = databuffer;
  //p->len=TOLLEN;
  //p->tot_len=TOLLEN;
  //udp_send(upcb,p_temp);//,&destAddr,port);
  //pbuf_free(p_temp);
